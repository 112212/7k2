...
uint32_t	last_unit_ai_profile_time = 0L;
uint32_t	unit_ai_profile_time = 0L;
uint32_t	last_unit_profile_time = 0L;
uint32_t	unit_profile_time = 0L;
uint32_t pathfind_profile_time = 0L;
uint32_t last_pathfind_profile_time = 0L;
// ######## begin Gilbert 27/4 #######//
uint32_t pathfind_count = 0L;
uint32_t last_pathfind_count = 0L;
uint32_t longest_pathfind_profile_time = 0L;
uint32_t last_longest_pathfind_profile_time = 0L;
uint32_t longest_pathfind_unit_recno = 0L;
uint32_t last_longest_pathfind_unit_recno = 0L;
// ######## end Gilbert 27/4 #######//
uint32_t	path_reuse_profile_time = 0L;
uint32_t last_path_reuse_profile_time = 0L;
uint32_t last_sprite_array_profile_time = 0L;
uint32_t sprite_array_profile_time = 0L;
uint32_t last_sprite_idle_profile_time = 0L;
uint32_t sprite_idle_profile_time = 0L;
uint32_t last_sprite_move_profile_time = 0L;
uint32_t sprite_move_profile_time = 0L;
uint32_t last_sprite_wait_profile_time = 0L;
uint32_t sprite_wait_profile_time = 0L;
uint32_t last_sprite_attack_profile_time = 0L;
uint32_t sprite_attack_profile_time = 0L;
uint32_t last_unit_attack_profile_time = 0L;
uint32_t unit_attack_profile_time = 0L;
uint32_t last_unit_assign_profile_time = 0L;
uint32_t unit_assign_profile_time = 0L;
uint32_t	last_unit_process_town_defender_profile_time = 0L;
uint32_t	unit_process_town_defender_profile_time = 0L;
uint32_t	last_unit_process_camp_defender_profile_time = 0L;
uint32_t	unit_process_camp_defender_profile_time = 0L;
uint32_t	last_unit_process_rebel_profile_time = 0L;
uint32_t	unit_process_rebel_profile_time = 0L;
uint32_t	last_unit_execute_move_profile_time = 0L;
uint32_t	unit_execute_move_profile_time = 0L;
uint32_t	last_unit_execute_attack_profile_time = 0L;
uint32_t	unit_execute_attack_profile_time = 0L;
uint32_t	last_unit_execute_build_firm_profile_time = 0L;
uint32_t	unit_execute_build_firm_profile_time = 0L;
uint32_t	last_unit_execute_settle_town_profile_time = 0L;
uint32_t	unit_execute_settle_town_profile_time = 0L;
uint32_t	last_unit_execute_assign_profile_time = 0L;
uint32_t	unit_execute_assign_profile_time = 0L; 
uint32_t	unit_check_build_firm_profile_time = 0L;
uint32_t	last_unit_check_build_firm_profile_time = 0L;
uint32_t	unit_cast_power_profile_time = 0L;
uint32_t	last_unit_cast_power_profile_time = 0L;
uint32_t	unit_transform_fortress_profile_time = 0L;
uint32_t	last_unit_transform_fortress_profile_time = 0L;
