...
public:
	...
	int32_t			 win_condition_count;
	int32_t			 lose_condition_count;
	EndCondition win_condition[MAX_WIN_CONDITION];
	EndCondition lose_condition[MAX_LOSE_CONDITION];
	int32_t			 win_deadline;

	//---------- game results ------------//

	int32_t			 result_win_condition_id;
	int32_t			 result_lose_condition_id;
...
public:
	...
	int32_t			max_ranking;			// lobbied game
	WORD			player_ranking[MAX_NATION];
	int32_t			generated_serial;		// generated by serial_repository
